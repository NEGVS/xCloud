...
import com.ruoyi.common.result.ResponseResult;
import com.ruoyi.common.utils.CodeX;
import com.ruoyi.common.utils.SecurityUtils;
import com.ruoyi.demi.xFinance.entity.XFinancials;
import com.ruoyi.demi.xFinance.mapper.XFinancialsMapper;
import com.ruoyi.demi.xOrder.entity.XOrderItems;
import com.ruoyi.demi.xOrder.entity.XOrderMessage;
import com.ruoyi.demi.xOrder.entity.XOrders;
import com.ruoyi.demi.xOrder.mapper.XOrderItemsMapper;
import com.ruoyi.demi.xOrder.mapper.XOrdersMapper;
import com.ruoyi.demi.xOrder.param.*;
import com.ruoyi.demi.xOrder.service.IXOrdersService;
import com.ruoyi.demi.xProduct.entity.XProducts;
import com.ruoyi.demi.xProduct.service.IXProductsService;
import com.ruoyi.demi.xShoppingCart.domain.XShoppingCart;
import com.ruoyi.demi.xShoppingCart.mapper.XShoppingCartMapper;
...
public class XOrdersServiceImpl implements IXOrdersService
{
   ...
   public ResponseResult insertXOrders( XOrders xOrders )
   {
      int count = 0;
      /**
       * 1-create order
      ...
      return ResponseResult.success( "orderCount:" + countAtomic, ", OrderItemCount:" + countAtomicItems + ", financial:" + countAtomicFinancials );
   }
   ...
   @Override
   @Transactional(rollbackFor = Exception.class)
   public AjaxResult addOrder(OrderParam dto) {
      ...
      // 获取参数中的商品ID列表
      List<Long> productIdList = dto.getProductList().stream()
              .map(OrderProductParam::getProductId)
      ...
      // 5. 返回订单信息
      return AjaxResult.success(buildOrderResponse(order, totalAmount, detailInfoList, dto));
   }
    ...
    * @return 总金额
    */
   private BigDecimal processShoppingCart(List<XShoppingCart> shoppingCarts, List<Long> productIdList, OrderParam dto,
                                          List<XOrderItems> itemsList, List<OrderDetailInfoDTO> detailInfoList) {
   ...
   private void validateCartAgainstOrder(XShoppingCart cart, List<Long> productIdList, OrderParam dto) {
      ...
      Optional<OrderProductParam> productOpt = dto.getProductList().stream()
   ...
   // 提取方法：构建返回的订单信息
   private OrderInfoDTO buildOrderResponse(XOrders order, BigDecimal totalAmount,
                                           List<OrderDetailInfoDTO> detailInfoList, OrderParam dto) {
    ...
    */
   @Override
   public AjaxResult testPay(String paymentId) {
      ...
      if (!object.equals(1)) {
         return AjaxResult.success("订单数据异常，请检查，订单支付ID：{}", paymentId);
      }
      // 修改redis中的支付状态
